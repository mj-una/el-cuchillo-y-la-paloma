```      
 ...
 \          \.'   |  | |\          \ .'  .-,  '.  |  _ _   \  \ .-.') .'  __ `.
  ...
  "El cuchillo y la paloma"
   ...
   Tomar el camino número: [numero del 1 al 7]

   {
     ESTA LA UNICA PARTE QUE NO ES TEXTO PLANO
     tenemos una variable: dependiendo del lo que se responda
     se guardara en la memoria una frase para usarla en el final.
